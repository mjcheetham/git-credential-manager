...
public static class AnsiConsoleFactory
{
    ...
    {
        using var _ = Trace2.CreateRegion("ansi_console", "create_tty");
    ...
    {
        using var _ = Trace2.CreateRegion("ansi_console", "create_writer");
    ...
    {
        using var _ = Trace2.CreateRegion("ansi_console", "create_headless");
        IAnsiConsole inner = AnsiConsole.Create(
            new AnsiConsoleSettings
            {
