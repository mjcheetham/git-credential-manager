...
public class ConsoleService : IConsoleService
{
    ...
    public void WriteInfo(string message) => _stderrConsole.MarkupLine($"[blue]info:[/] {message}");

    public void WriteWarning(string message) => _stderrConsole.MarkupLine($"[yellow]warning:[/] {message}");

    public void WriteError(string message) => _stderrConsole.MarkupLine($"[red]error:[/] {message}");
