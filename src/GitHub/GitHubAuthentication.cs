...
namespace GitHub
{
    ...
    public class GitHubAuthentication : AuthenticationBase, IGitHubAuthentication
    {
        ...
        public async Task<string> SelectAccountAsync(Uri targetUri, IEnumerable<string> accounts)
        {
            ...
            var choice = await prompt.ShowAsync(Context.Console.Interactive, CancellationToken.None);
        ...
        private async Task<AuthenticationPromptResult> GetAuthenticationViaTtyAsync(Uri targetUri, string userName, AuthenticationModes modes)
        {
            ...
            switch (modes)
            {
                case AuthenticationModes.Basic:
                    ...
                    if (string.IsNullOrWhiteSpace(userName))
                    {
                        userName = await Context.Console.PromptAsync("Username");
                    }
                    else
                    {
                    ...
                    string password = await Context.Console.PromptSecretAsync("Password");
                ...
                case AuthenticationModes.Pat:
                    ...
                    string pat = await Context.Console.PromptSecretAsync("Token");
                    return new AuthenticationPromptResult(
                ...
                default:
                    ...
                    AuthenticationModes choice = await prompt.SelectItemAsync(Context.Console.Interactive);
        ...
        private async Task<string> GetTwoFactorCodeViaTtyAsync(bool isSms)
        {
            ...
            return await Context.Console.PromptAsync("Authentication code");
        }
