...
[gcm-mi-config]: configuration.md#credentialazreposmanagedidentity
[gcm-wif-config]: configuration.md#credentialazreposworkloadfederation
[gcm-wif-clientid-config]: configuration.md#credentialazreposworkloadfederationclientid
[gcm-wif-tenantid-config]: configuration.md#credentialazreposworkloadfederationtenantid
[gcm-wif-audience-config]: configuration.md#credentialazreposworkloadfederationaudience
[gcm-wif-assertion-config]: configuration.md#credentialazreposworkloadfederationassertion
[gcm-wif-mi-config]: configuration.md#credentialazreposworkloadfederationmanagedidentity
[gcm-wif-env]: environment.md#GCM_AZREPOS_WIF
[gcm-wif-clientid-env]: environment.md#GCM_AZREPOS_WIF_CLIENTID
[gcm-wif-tenantid-env]: environment.md#GCM_AZREPOS_WIF_TENANTID
[gcm-wif-audience-env]: environment.md#GCM_AZREPOS_WIF_AUDIENCE
[gcm-wif-assertion-env]: environment.md#GCM_AZREPOS_WIF_ASSERTION
[gcm-wif-mi-env]: environment.md#GCM_AZREPOS_WIF_MANAGEDIDENTITY
