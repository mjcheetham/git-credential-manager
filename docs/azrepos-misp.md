...
[gcm-mi-env]: environment.md#GCM_AZREPOS_MANAGEDIDENTITY
[gcm-sp-config]: configuration.md#credentialazreposserviceprincipal
[gcm-sp-env]: environment.md#GCM_AZREPOS_SERVICE_PRINCIPAL
[gcm-sp-secret-config]: configuration.md#credentialazreposserviceprincipalsecret
[gcm-sp-secret-env]: environment.md#GCM_AZREPOS_SP_SECRET
[gcm-sp-cert-config]: configuration.md#credentialazreposserviceprincipalcertificatethumbprint
[gcm-sp-cert-x5c-config]: configuration.md#credentialazreposserviceprincipalcertificatesendx5c
[gcm-sp-cert-env]: environment.md#GCM_AZREPOS_SP_CERT_THUMBPRINT
[gcm-sp-cert-x5c-env]: environment.md#GCM_AZREPOS_SP_CERT_SEND_X5C
